...
Перші N діалогів (за замовчуванням 100) проганяються через Llama 3.1 8b батчами по 10.
...
`augment_with_variations()` бере до 100 унікальних фраз клієнтів і 100 фраз агентів,
